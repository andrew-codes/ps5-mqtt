<div align="center">
    ...
    <div style="display: flex;">
        <a href="https://github.com/andrew-codes/ps5-mqtt/releases">
            <img src="https://img.shields.io/github/release/andrew-codes/ps5-mqtt.svg">
        </a>
        <a href="https://github.com/sponsors/andrew-codes">
            <img src="https://img.shields.io/badge/Sponsor-GitHub-ea4aaa.svg?logo=githubsponsors">
        </a>
        <a href="#">
            <img src="https://img.shields.io/maintenance/yes/2026.svg">
        </a>
        <a href="https://github.com/andrew-codes/ps5-mqtt/LICENSE.md">
...
[![Open your Home Assistant instance and show the add add-on repository dialog with a specific repository URL pre-filled.](https://my.home-assistant.io/badges/supervisor_add_addon_repository.svg)](https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https%3A%2F%2Fgithub.com%2Fandrew-codes%2Fps5-mqtt-edge)
...
This project is forked from the [ps5-mqtt][ff-repo] add-on created by [FunkeyFlo][ff-user]. A huge thanks to them for building and maintaining the upstream project that this fork is based on. 🙏
...
[ff-repo]: https://github.com/FunkeyFlo/ps5-mqtt
...
[1.0.0]: https://github.com/andrew-codes/ps5-mqtt/releases/tag/v1.0.0
