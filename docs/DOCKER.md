...
services:
  ps5-mqtt:
    ...
    image: ghcr.io/andrew-codes/ps5-mqtt/amd64:latest # you can also use a specific version
...
[docker-images]: https://github.com/andrew-codes?tab=packages&repo_name=ps5-mqtt
...
[github-issues]: https://github.com/andrew-codes/ps5-mqtt/issues/new/choose
